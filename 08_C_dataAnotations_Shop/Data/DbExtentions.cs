        ...
        public static void SeedData(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Position>().HasData(new[]
           {
            ...
            modelBuilder.Entity<Worker>().HasData(new Worker[]
            {
                ...
                new() {Id = 2, Name = "Vitya", Surname = "Vityovich", Salary = 5000, Gmail = "viktor523@gmail.com", PhoneNumber = "+380 66 734 9273", PositionId = 1, ShopId = 2},
                new() {Id = 3, Name = "Sashka", Surname = "Sanych", Salary = 1500, Gmail = "sasha235@gmail.com", PhoneNumber = "+380 97 435 9273", PositionId = 3, ShopId = 3}
            });
            ...
            modelBuilder.Entity<Product>().HasData(new Product[]
           {
                ...
                new() { Id = 2, Name = "Easel", Price = 300, Discount = 6.5f , Quantity = 10, IsInStock = true, CategoryId = 2   },
                new() { Id = 3, Name = "Smartphone", Price = 6000, Discount = 3.5f , Quantity = 15, IsInStock = true, CategoryId = 3  }
