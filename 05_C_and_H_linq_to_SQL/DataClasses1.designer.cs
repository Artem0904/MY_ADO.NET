...
namespace linq_to_SQL
{
    ...
    partial void OnNameChanging(string value);
    partial void OnNameChanged();
    partial void OnCountPagesChanging(int value);
    partial void OnCountPagesChanged();
    ...
    partial void OnAuthorIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CountPages", DbType="Int NOT NULL")]
		public int CountPages
		{
			...
			set
			{
				if ((this._CountPages != value))
				{
					this.OnCountPagesChanging(value);
					this.SendPropertyChanging();
					this._CountPages = value;
					this.SendPropertyChanged("CountPages");
					this.OnCountPagesChanged();
				}
			}
		}
